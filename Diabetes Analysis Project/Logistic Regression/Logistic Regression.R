#Question trying to answer using Logistic Regression.
#1. We are trying to predict the Outcome (diabetic or non-diabetic) of the person based on the other features in the dataset.
...
#Loading the dataset
diabetes <- read_csv("D:/MITA/SPRING/Multivariate_Analysis/Homework/Logistic Regression/diabetes.csv")
View(diabetes)
str(diabetes)
...
#This means that, the person is less likely or does not have the diabetes based on our model's output.